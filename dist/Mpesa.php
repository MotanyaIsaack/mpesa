...
class Mpesa
{
    ...
    {
        $url = 'https://' . $_ENV["MPESA_SUBDOMAIN"] . '.safaricom.co.ke/mpesa/stkpush/v1/processrequest';
    ...
    {
        $url = 'https://' . $_ENV["MPESA_SUBDOMAIN"] . '.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';
